...
def getLinks(tvshow, season, episode):
    ...
    if urltv != "":
        ...
        if src_urltv != -1:
            for line in ''.join(src_urltv).split('"site"'):
                #splitter correctement pour
                #trouver http://watchseries.eu/open/cale/5443107/idepisod/160752.html
                #
                #dans les modules, 
                ...
                for nameModule in watchserieseu_mod.__all__:
                    if nameModule in line:
                        ...
                        link = "http://watchseries.eu/" + href[1].split('"')[1][3:]
                        print link
                        possible_links.append([link, \
                            "watchserieseu_mod." + nameModule])
