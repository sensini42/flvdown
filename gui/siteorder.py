...
class Siteorder(QtGui.QWidget):
    ...
    def populate(self, list_site):
        ...
        mainLayout.addWidget(self.list_site, 0, 1, 2, 1)
        mainLayout.addWidget(button_up, 0, 2)
        mainLayout.addWidget(button_down, 1, 2)

        button_save = QtGui.QPushButton("Save config file")
        self.connect(button_save, SIGNAL("clicked()"), self.saveClicked)
        mainLayout.addWidget(button_save, 2, 1)
